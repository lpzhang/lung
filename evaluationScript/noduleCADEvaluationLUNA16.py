...
# basePath=os.getcwd()
# print basePath
# annotations_filename          = os.path.join(basePath,'annotations/annotations.csv')
# annotations_excluded_filename = os.path.join(basePath,'annotations/annotations_excluded.csv')
# seriesuids_filename           = os.path.join(basePath,'annotations/seriesuids.csv')
# results_filename              = os.path.join(os.path.split(basePath)[0],'result/mysubmission.csv')
# outputDir                     = os.path.join(basePath,'evaluation_results')
