...
params['ModelParams']['dirResult']=os.path.join(basePath,'result/resnet_50') #where we need to save the results (relative to the base path)
params['ModelParams']['dirSnapshots']=os.path.join(basePath,'output/resnet_50') #where to save the models while training
params['ModelParams']['SnapshotPrefix']= os.path.join(params['ModelParams']['dirSnapshots'],'resnet_50')
